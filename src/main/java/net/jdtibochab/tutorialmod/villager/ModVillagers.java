package net.jdtibochab.tutorialmod.villager;
...
public class ModVillagers {
    ...
    public static RegistryObject<PoiType> JUMPY_BLOCK_POI = POI_TYPES.register("jumpy_block_poi",
            () -> new PoiType(ImmutableSet.copyOf(ModBlocks.JUMPY_BLOCK.get().getStateDefinition().getPossibleStates()),
                    1,1));
    public static RegistryObject<VillagerProfession> JUMPY_MASTER = VILLAGER_PROFESSIONS.register("jumpy_master",
