...
@OnlyIn(Dist.CLIENT)
public abstract class SanicEnergySwirlLayer<T extends Entity & PowerableMob, M extends EntityModel<T>> extends RenderLayer<T, M> {
    public SanicEnergySwirlLayer(RenderLayerParent<T, M> pRenderer) {
        super(pRenderer);
    }
