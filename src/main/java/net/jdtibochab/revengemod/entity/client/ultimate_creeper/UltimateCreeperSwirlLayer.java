...
@OnlyIn(Dist.CLIENT)
public abstract class UltimateCreeperSwirlLayer<T extends Entity & PowerableMob, M extends EntityModel<T>> extends RenderLayer<T, M> {
    public UltimateCreeperSwirlLayer(RenderLayerParent<T, M> pRenderer) {
        super(pRenderer);
    }
