...
public class UltimateCreeperSwellGoal extends Goal{
    private final UltimateCreeperEntity creeper;
    @Nullable
    private LivingEntity target;

    public UltimateCreeperSwellGoal(UltimateCreeperEntity pCreeper) {
