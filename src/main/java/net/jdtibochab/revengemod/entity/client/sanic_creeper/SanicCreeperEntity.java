...
public class SanicCreeperEntity extends Creeper implements PowerableMob {
    ...
    public SanicCreeperEntity(EntityType<? extends net.minecraft.world.entity.monster.Creeper> pEntityType, Level pLevel) {
