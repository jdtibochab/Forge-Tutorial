...
public enum ModArmorMaterials implements ArmorMaterial {
    HAZMAT("hazmat", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.LEATHER);
    }),
    ATOMIC("atomic", 37, new int[]{3, 6, 8, 3}, 15,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 9.0F, 0.3F, () -> {
    ...
    public String getName() {
        return RevengeMod.MOD_ID + ":" + this.name;
    }
